...
export function setup(ctx: SpindleFrontendContext) {
  ...
  // ── Inject scoped styles into the tab root ─────────────────────────────────
  ...
  // ── Helper: build a Goals/Objectives section ───────────────────────────────
  ...
  // ── Helper: build a number spinner ────────────────────────────────────────
  function buildSpinner(labelText: string): HTMLElement {
  ...
  // ── Build the Council button ───────────────────────────────────────────────
  function buildCouncilButton(): HTMLElement {
    const section = document.createElement('div')
    section.className = 'gobj-section'
